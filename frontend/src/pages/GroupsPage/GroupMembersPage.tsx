...
const GroupMembersPage = ({ group, onBack }: Props) => {
  ...
  const applyMembersResults = useCallback(
    ([membersResult, debtsResult]: Awaited<ReturnType<typeof loadMembersData>>) => {
      ...
      // Odwrócony warunek (zamiast != "fulfilled" zrobione na == "fulfilled")
      if (membersResult.status === "fulfilled") {
        ...
        globalThis.console.error("Błąd pobierania członków grupy:", membersResult.reason);
        setMembers([]);
      ...
      if (debtsResult.status === "fulfilled") {
        ...
        globalThis.console.error("Błąd pobierania długów grupy:", debtsResult.reason);
        setDebts([]);
        setErrorMessage((current) =>
  ...
  const handleAddMember = async () => {
    ...
    try {
      ...
      globalThis.console.error("Błąd dodawania członka:", error);
  ...
  const handleRemove = async (id: number | string) => {
    ...
    try {
      ...
      globalThis.console.error("Błąd usuwania członka:", error);
      setErrorMessage(
  ...
  const handleCreateDebt = async () => {
    ...
    try {
      ...
      globalThis.console.error("Błąd dodawania długu:", error);
  ...
  const handleDeleteDebt = async () => {
    ...
    try {
      ...
      globalThis.console.error("Błąd usuwania długu:", error);
  ...
  const handleMarkDebtAsPaid = async (debtId: number | string) => {
    try {
      ...
      globalThis.console.error("Błąd oznaczania długu jako opłaconego:", error);
      setErrorMessage(
  ...
  const handleConfirmDebtPayment = async (debtId: number | string) => {
    try {
      ...
      globalThis.console.error("Błąd potwierdzania spłaty długu:", error);
      setErrorMessage(
